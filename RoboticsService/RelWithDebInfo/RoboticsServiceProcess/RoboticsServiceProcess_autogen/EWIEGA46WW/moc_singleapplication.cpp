...
#include "../../../../RoboticsServiceProcess/singleapplication.h"
...
constexpr auto qt_meta_stringdata_CLASSSingleApplicationENDCLASS = QtMocHelpers::stringData(
    "SingleApplication",
    "activeWindowSiganl",
    "",
    "onNewConnection"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSingleApplicationENDCLASS_t qt_meta_stringdata_CLASSSingleApplicationENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(18, 18),  // "activeWindowSiganl"
        QT_MOC_LITERAL(37, 0),  // ""
...
void SingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->activeWindowSiganl(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SingleApplication::activeWindowSiganl; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SingleApplication::activeWindowSiganl()
{
